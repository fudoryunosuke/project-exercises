...
<main class="flex-1 p-8 overflow-y-auto">
  <section id="reportContent" class="a4-page">
    ...
    <div id="reportDetails" class="grid grid-cols-2 gap-2 p-2 bg-gray-100 border rounded">
      ...
      <div><span class="font-semibold">大きさ:</span> <span id="r-size"></span></div>
      <div><span class="font-semibold">実施日時:</span> <span id="r-inspectionTime"></span></div>
      ...
      <div><span class="font-semibold">点検区間:</span> <span id="r-inspectionSection"></span></div>
      <div><span class="font-semibold">応急処置:</span> <span id="r-temporaryRepair"></span></div>
    </div>
