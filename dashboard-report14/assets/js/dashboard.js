...
(function(){
  ...
  const stats = [
    ...
    { label: '損傷範囲 (大)', value: high.length, borderColor: 'border-red-500', description: '広範囲の補修が必要' },
    { label: '損傷範囲 (中)', value: mid.length, borderColor: 'border-orange-500', description: '通常の補修が必要' },
    { label: '損傷範囲 (小)', value: low.length, borderColor: 'border-green-500', description: '経過観察など' },
  ...
  urgentCard.appendChild(h(`<h2 class="text-lg font-bold text-red-400 mb-3">緊急度が高い損傷 (大)</h2>`));
